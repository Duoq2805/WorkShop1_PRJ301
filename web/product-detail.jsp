        ...
        <div class="container">
            <c:choose>
                <c:when test="${product != null}">
                    ...
                    <div class="product-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="ViewProductsServlet">Sản phẩm</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-info">
                                ...
                                <a href="ViewProductsServlet" class="btn btn-back">
                ...
                <c:otherwise>
                    ...
                    <a href="ViewProductsServlet" class="btn btn-back mt-3">
                        <i class="fas fa-arrow-left me-2"></i>Quay lại danh sách
                    </a>
                </c:otherwise>
            </c:choose>
